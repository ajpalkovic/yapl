!function($) {
  ...
  var ParseActions = {
    ...
    ForInStructure: node('ForInStructure', ['variable', 'collection', 'index']),
    MultipleForInStructure: node('MultipleForInStructure', ['key', 'value', 'object', 'index']),
    InflectedForStructure: node('InflectedForStructure', ['variable']),
